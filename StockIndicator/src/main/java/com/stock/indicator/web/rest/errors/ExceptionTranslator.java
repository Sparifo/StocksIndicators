package com.stock.indicator.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.stock.indicator.service.EmailAlreadyUsedException ||
            ex instanceof com.stock.indicator.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.stock.indicator.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.stock.indicator");
    }
}
